import { Award, HeartHandshake, ShieldCheck, Sparkles, Scissors } from "lucide-react";
import { IMAGES } from "@/lib/site";

const values = [
  { icon: Award, label: "Experiencia" },
  { icon: Scissors, label: "Oficio" },
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div className="relative">
            <img
              ...
              alt="Trabajo de costura realizado con cuidado"
              loading="lazy"
          ...
          <div>
            ...
            <h2 className="mt-3 font-display text-3xl font-semibold leading-tight tracking-tight sm:text-4xl">
              Cada arreglo merece atención y cuidado.
            </h2>
            <p className="mt-4 text-muted-foreground">
              Detrás de cada prenda hay años de experiencia, oficio y atención
              personalizada. Mara escucha qué necesitás y busca una solución
              práctica para que puedas seguir usando lo que ya tenés.
            </p>
